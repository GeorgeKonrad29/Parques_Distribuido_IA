...
const GameTokens: React.FC<GameTokensProps> = ({ 
  ...
  const getBoardPositionCoords = (position: number): { x: number; y: number } => {
    ...
    // 29-45 (rotación 180°)
    if (normalizedPos === 46) return { x: 96, y: 47 };
    if (normalizedPos === 47) return { x: 96, y: 40 };
    if (normalizedPos === 48) return { x: 91.8, y: 40 };
    if (normalizedPos === 49) return { x: 87.8, y: 40 };
    if (normalizedPos === 50) return { x: 83.8, y: 40 };
    if (normalizedPos === 51) return { x: 79.6, y: 40 };
    if (normalizedPos === 52) return { x: 75.5, y: 40 };
    if (normalizedPos === 53) return { x: 70.5, y: 39 };
    if (normalizedPos === 54) return { x: 65.5, y: 37 };
    if (normalizedPos === 55) return { x: 62, y: 33.5 };
    if (normalizedPos === 56) return { x: 60, y: 29 };
    if (normalizedPos === 57) return { x: 59, y: 23.7 };
    if (normalizedPos === 58) return { x: 59, y: 19.5 };
    if (normalizedPos === 59) return { x: 59, y: 15.5 };
    if (normalizedPos === 60) return { x: 59, y: 11.5 };
    if (normalizedPos === 61) return { x: 59, y: 7 };
    if (normalizedPos === 62) return { x: 59, y: 3 };
    // 46-62 (rotación 270° CCW = 90° CW del segmento base anterior)
    if (normalizedPos === 29) return { x: 47, y: 3 };
    if (normalizedPos === 30) return { x: 40, y: 3 };
    if (normalizedPos === 31) return { x: 40, y: 7.2 };
    if (normalizedPos === 32) return { x: 40, y: 11.2 };
    if (normalizedPos === 33) return { x: 40, y: 15.2 };
    if (normalizedPos === 0) return { x: 40, y: 19 };
    if (normalizedPos === 1) return { x: 40, y: 23.8 };
    if (normalizedPos === 2) return { x: 39, y: 29 };
    if (normalizedPos === 3) return { x: 37, y: 33 };
    if (normalizedPos === 4) return { x: 33.8, y: 36.8 };
    if (normalizedPos === 5) return { x: 29, y: 39 };
    if (normalizedPos === 6) return { x: 23.7, y: 40 };
    if (normalizedPos === 7) return { x: 19.3, y: 40 };
    if (normalizedPos === 8) return { x: 15, y: 40 };
    if (normalizedPos === 9) return { x: 11, y: 40 };
    if (normalizedPos === 10) return { x: 7, y: 40 };
    if (normalizedPos === 11) return { x: 3, y: 40 };
    // Fallback
    return { x: 50, y: 50 };
  };
